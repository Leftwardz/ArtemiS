...
# Map POSIX identity env vars to the names ArtemiS expects on Windows.
os.environ.setdefault("USERNAME", os.environ.get("USER", "dev"))
os.environ.setdefault("USERDOMAIN", os.environ.get("HOSTNAME", "LOCAL"))
