...
[x] Etapa 2: Isolamento dos Modelos de Banco de Dados (app/models)
  ...
  (x) Ponte Database.py removida — imports via app.models
[x] Etapa 3: Modularização de Utilitários (app/utils)
  ...
  (x) Ponte utils.py removida — imports via app.utils
[x] Etapa 4: Isolamento de Regras de Negócio e PDFs (app/services)
  ...
  [x] Ajustar imports restantes — pontes removidas (A3)
...
---
Plano detalhado: docs/REFACTOR_PLAN.md — **Fases A–E e A3 concluídas**.
